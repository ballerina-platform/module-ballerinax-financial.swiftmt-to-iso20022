    ...
    swiftmt:Block3? block3) returns pacsIsoRecord:CreditTransferTransaction62[]|error {
        ...
        cdtTrfTxInfArray.push({
            ...
            UndrlygCstmrCdtTrf: {
                ...
                RmtInf: remmitanceInfo2 == "" ? () : {Ustrd: [getRemmitanceInformation(
                    block4.UndrlygCstmrCdtTrf.MT70?.Nrtv?.content)], Strd: []}
            }
        });
...
isolated function transformMT202ToPacs004(swiftmt:MT202Message message) returns pacsIsoRecord:Pacs004Envelope|error =>
    ...
    [string?, pacsIsoRecord:PaymentReturnReason7[]] [instructionId, returnReasonArray] = 
        get202Or205RETNSndRcvrInfoForPacs004(message.block4.MT72) in {
    AppHdr: {
        Fr: {FIId: {FinInstnId: {BICFI: getMessageSender(message.block1?.logicalTerminal,
            message.block2.MIRLogicalTerminal)}}}, 
        To: {FIId: {FinInstnId: {BICFI: getMessageReceiver(message.block1?.logicalTerminal,
