...
isolated function transformMT202Pacs009(swiftmt:MT202Message message) returns pacsIsoRecord:Pacs009Envelope|error => let 
    ...
    pacsIsoRecord:RemittanceInformation2?, pacsIsoRecord:Purpose2Choice?][instrFrCdtrAgt, instrFrNxtAgt, prvsInstgAgt1,
    intrmyAgt2, serviceLevel, lclInstrm, catPurpose, remmitanceInfo, purpose] = 
    check getMT2XXSenderToReceiverInfo(message.block4.MT72),
        ...
        FICdtTrf: {
            GrpHdr: {
                ...
                SttlmInf: {
                    ...
                    InstgRmbrsmntAgtAcct: getCashAccount(message.block4.MT53A?.PrtyIdn, message.block4.MT53B?.PrtyIdn, message.block4.MT53D?.PrtyIdn),
                    ...
                    InstdRmbrsmntAgtAcct: getCashAccount(message.block4.MT54A?.PrtyIdn, message.block4.MT54B?.PrtyIdn, message.block4.MT54D?.PrtyIdn)
                },
            ...
            CdtTrfTxInf: [
                {
                    Cdtr: getMandatoryFinancialInstitution(message.block4.MT58A?.IdnCd?.content, message.block4.MT58D?.Nm, message.block4.MT58A?.PrtyIdn,
                        message.block4.MT58D?.PrtyIdn, (), (), message.block4.MT58D?.AdrsLine),
                    CdtrAcct: getCashAccount(message.block4.MT58A?.PrtyIdn, message.block4.MT58D?.PrtyIdn),
                    CdtrAgt: getOptionalFinancialInstitution(message.block4.MT57A?.IdnCd?.content, message.block4.MT57D?.Nm, message.block4.MT57A?.PrtyIdn,
                        message.block4.MT57B?.PrtyIdn, message.block4.MT57D?.PrtyIdn, (), message.block4.MT57D?.AdrsLine, message.block4.MT57B?.Lctn?.content),
                    CdtrAgtAcct: getCashAccount(message.block4.MT57A?.PrtyIdn, message.block4.MT57B?.PrtyIdn, message.block4.MT57D?.PrtyIdn),
                    IntrBkSttlmAmt: {
                    ...
                    Dbtr: getMandatoryFinancialInstitution(message.block4.MT52A?.IdnCd?.content, message.block4.MT52D?.Nm, message.block4.MT52A?.PrtyIdn,
                    ...
                    IntrmyAgt1: getOptionalFinancialInstitution(message.block4.MT56A?.IdnCd?.content, message.block4.MT56D?.Nm, message.block4.MT56A?.PrtyIdn,
...
# + return - Returns a `Pacs009Document` object if the transformation is successful,
# otherwise returns an error.
isolated function transformMT202COVToPacs009(swiftmt:MT202COVMessage message) returns pacsIsoRecord:Pacs009Envelope|error => {
    AppHdr: {
        Fr: {FIId: {FinInstnId: {BICFI: getMessageSender(message.block1?.logicalTerminal, message.block2.MIRLogicalTerminal)}}}, 
        To: {FIId: {FinInstnId: {BICFI: getMessageReceiver(message.block1?.logicalTerminal, message.block2.receiverAddress)}}}, 
        BizMsgIdr: message.block4.MT20.msgId.content, 
...
# otherwise returns an error.
isolated function getMT202COVCreditTransfer(swiftmt:MT202COVMessage message, swiftmt:MT202COVBlock4 block4, swiftmt:Block3? block3) returns pacsIsoRecord:CreditTransferTransaction62[]|error {
    ...
    [InstructionForCreditorAgentArray, InstructionForNextAgent1Array, pacsIsoRecord:BranchAndFinancialInstitutionIdentification8?, pacsIsoRecord:BranchAndFinancialInstitutionIdentification8?, string?, pacsIsoRecord:LocalInstrument2Choice?, pacsIsoRecord:CategoryPurpose1Choice?, pacsIsoRecord:RemittanceInformation2?, pacsIsoRecord:Purpose2Choice?] [instrFrCdtrAgt, instrFrNxtAgt, prvsInstgAgt1,
    intrmyAgt2, serviceLevel, lclInstrm, catPurpose, remmitanceInfo, purpose] = 
    check getMT2XXSenderToReceiverInfo(message.block4.MT72);
    string remmitanceInfo2 = getRemmitanceInformation(block4.UndrlygCstmrCdtTrf.MT70?.Nrtv?.content);
    cdtTrfTxInfArray.push({
        Cdtr: getMandatoryFinancialInstitution(block4.MT58A?.IdnCd?.content, block4.MT58D?.Nm, block4.MT58A?.PrtyIdn,
            block4.MT58D?.PrtyIdn, (), (), block4.MT58D?.AdrsLine),
        CdtrAcct: getCashAccount(block4.MT58A?.PrtyIdn, block4.MT58D?.PrtyIdn),
        CdtrAgt: getOptionalFinancialInstitution(block4.MT57A?.IdnCd?.content, block4.MT57D?.Nm, block4.MT57A?.PrtyIdn,
        ...
        Dbtr: getMandatoryFinancialInstitution(block4.MT52A?.IdnCd?.content, block4.MT52D?.Nm, block4.MT52A?.PrtyIdn,
            block4.MT52D?.PrtyIdn, (), (), block4.MT52D?.AdrsLine),
        DbtrAcct: getCashAccount(block4.MT52A?.PrtyIdn, block4.MT52D?.PrtyIdn),
        IntrmyAgt1: getOptionalFinancialInstitution(block4.MT56A?.IdnCd?.content, block4.MT56D?.Nm, block4.MT56A?.PrtyIdn,
        ...
        UndrlygCstmrCdtTrf: {
            ...
            DbtrAcct: getCashAccountForDbtrOrCdtr(block4.UndrlygCstmrCdtTrf.MT50A?.Acc, block4.UndrlygCstmrCdtTrf.MT50K?.Acc, (), block4.UndrlygCstmrCdtTrf.MT50F?.PrtyIdn),
            DbtrAgt: getMandatoryFinancialInstitution(ordgInstn52A?.IdnCd?.content, ordgInstn52D?.Nm, ordgInstn52A?.PrtyIdn,
            ordgInstn52D?.PrtyIdn, (), (), ordgInstn52D?.AdrsLine),
            ...
            IntrmyAgt1: getOptionalFinancialInstitution(block4.UndrlygCstmrCdtTrf.MT56A?.IdnCd?.content, block4.UndrlygCstmrCdtTrf.MT56D?.Nm, block4.UndrlygCstmrCdtTrf.MT56A?.PrtyIdn,
            block4.UndrlygCstmrCdtTrf.MT56D?.PrtyIdn, (), (), block4.UndrlygCstmrCdtTrf.MT56D?.AdrsLine),
            IntrmyAgt1Acct: getCashAccount(block4.UndrlygCstmrCdtTrf.MT56A?.PrtyIdn, block4.UndrlygCstmrCdtTrf.MT56D?.PrtyIdn),
            CdtrAgt: getMandatoryFinancialInstitution(cdtrAgt57A?.IdnCd?.content, cdtrAgt57D?.Nm, cdtrAgt57A?.PrtyIdn,
            cdtrAgt57D?.PrtyIdn, (), (), cdtrAgt57D?.AdrsLine),
            CdtrAgtAcct: getCashAccount(cdtrAgt57A?.PrtyIdn, cdtrAgt57B?.PrtyIdn, cdtrAgt57C?.PrtyIdn, cdtrAgt57D?.PrtyIdn),
            ...
            CdtrAcct: getCashAccountForDbtrOrCdtr(block4.UndrlygCstmrCdtTrf.MT59?.Acc, block4.UndrlygCstmrCdtTrf.MT59A?.Acc, block4.UndrlygCstmrCdtTrf.MT59F?.Acc),
            ...
            RmtInf: remmitanceInfo2 == "" ? () : {Ustrd: [getRemmitanceInformation(block4.UndrlygCstmrCdtTrf.MT70?.Nrtv?.content)], Strd: []}
        }
    });
...
# otherwise returns an error.
isolated function transformMT202ToPacs004(swiftmt:MT202Message message) returns pacsIsoRecord:Pacs004Envelope|error => let 
    string field57Acct = getPartyIdentifierOrAccount2(message.block4.MT57B?.PrtyIdn)[1].toString() + 
    ...
    string? partyIdentifier = getPartyIdentifierOrAccount2(message.block4.MT57A?.PrtyIdn, message.block4.MT57B?.PrtyIdn, message.block4.MT57D?.PrtyIdn)[0], 
    string? name = getNameForCdtrAgtInPacs004(message.block4.MT57B, getName(message.block4.MT57D?.Nm), field57Acct, field57AdrsLine),
    ...
    [string?, pacsIsoRecord:PaymentReturnReason7[]] [instructionId, returnReasonArray] = get202Or205RETNSndRcvrInfoForPacs004(message.block4.MT72) in {
    AppHdr: {
        Fr: {FIId: {FinInstnId: {BICFI: getMessageSender(message.block1?.logicalTerminal, message.block2.MIRLogicalTerminal)}}}, 
        To: {FIId: {FinInstnId: {BICFI: getMessageReceiver(message.block1?.logicalTerminal, message.block2.receiverAddress)}}}, 
        BizMsgIdr: message.block4.MT20.msgId.content, 
    ...
    Document: {
        PmtRtr: {
            ...
            TxInf: [{
                ...
                RtrChain: {
                   Cdtr: {
                        Agt: getMandatoryFinancialInstitution(message.block4.MT58A?.IdnCd?.content, message.block4.MT58D?.Nm, message.block4.MT58A?.PrtyIdn,
                            message.block4.MT58D?.PrtyIdn, (), (), message.block4.MT58D?.AdrsLine)
                    },
                    ...
                    Dbtr: {
                        Agt: getMandatoryFinancialInstitution(message.block4.MT52A?.IdnCd?.content, message.block4.MT52D?.Nm, message.block4.MT52A?.PrtyIdn,
                            message.block4.MT52D?.PrtyIdn, (), (), message.block4.MT52D?.AdrsLine)
                    },
                    IntrmyAgt1: getOptionalFinancialInstitution(message.block4.MT56A?.IdnCd?.content, message.block4.MT56D?.Nm, message.block4.MT56A?.PrtyIdn,
                        message.block4.MT56D?.PrtyIdn, (), (), message.block4.MT56D?.AdrsLine) 
