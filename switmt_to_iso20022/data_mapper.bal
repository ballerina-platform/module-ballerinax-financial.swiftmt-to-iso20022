...
public isolated function toIso20022Xml(string finMessage) returns xml|error {
    ...
    if validationFlag.length() > 0 {
        isolated function (record {} message) returns record {}|error transformFunction = transformFunctionMap.get(messageType + validationFlag);
        return xmldata:toXml(check transformFunction(customizedMessage));
    }
    isolated function (record {} message) returns record {}|error transformFunction = transformFunctionMap.get(messageType);
            ...
            CdtTrfTxInf: [
                {
                    ...
                    CdtrAcct: {
                        Id: {
                            IBAN: validateAccountNumber(transaxion.MT59A?.Acc, transaxion.MT59?.Acc, transaxion.MT59F?.Acc)[0],
                            Othr: {
                                Id: validateAccountNumber(transaxion.MT59A?.Acc, transaxion.MT59?.Acc, transaxion.MT59F?.Acc)[1],
                                SchmeNm: {
                    ...
                    InstrForCdtrAgt: [
                        {
                            Cd: getMT101InstructionCode(transaxion.MT23E, 2)[2],
                            InstrInf: getMT101InstructionCode(transaxion.MT23E, 2)[3]
                        }
                    ],
                    RgltryRptg: getRegulatoryReporting(transaxion.MT77B),
                    RmtInf: {Ustrd: [getRemmitanceInformation(transaxion.MT70)[1]], Strd: []}
                }
            ],
            PmtTpInf: {
                SvcLvl: [
                    {
                        Cd: getMT101InstructionCode(transaxion.MT23E, 3)[4]
                    }
                ],
                CtgyPurp: {
                    Cd: getMT101InstructionCode(transaxion.MT23E, 4)[6]
                }
            },
            DbtrAcct: {
                Id: {
                    IBAN: getAccountId(validateAccountNumber(ordgCstm50G?.Acc, ordgCstm50H?.Acc)[0], getPartyIdentifierOrAccount(ordgCstm50F?.PrtyIdn)[1]),
                    Othr: {
                        Id: getAccountId(validateAccountNumber(ordgCstm50G?.Acc, ordgCstm50H?.Acc)[1], getPartyIdentifierOrAccount(ordgCstm50F?.PrtyIdn)[2]),
                        SchmeNm: {
            ...
            Dbtr: {
                Id: {
                    ...
                    PrvtId: {
                        Othr: [
                            {
                                Id: getPartyIdentifierOrAccount(ordgCstm50F?.PrtyIdn, PARTY_IDENTIER_ID)[0],
                                SchmeNm: {
                                    Cd: getPartyIdentifierOrAccount(ordgCstm50F?.PrtyIdn, PARTY_IDENTIFIER_CODE)[3]
                                },
...
isolated function getMT102STPCreditTransferTransactionInfo(swiftmt:MT102STPMessage message) returns pacsIsoRecord:CreditTransferTransaction64[]|error {
    ...
    foreach swiftmt:MT102STPTransaction transaxion in message.block4.Transaction {
        ...
        cdtTrfTxInfArray.push({
            ...
            RgltryRptg: getRegulatoryReporting(rgltyRptg),
            RmtInf: {Ustrd: [getRemmitanceInformation(transaxion.MT70)[1]], Strd: []},
            InstrForNxtAgt: [
                {
                ...
                CdtTrfTxInf: [
                    {
                        ...
                        PmtId: {
                            EndToEndId: getRemmitanceInformation(message.block4.MT70)[0],
                            InstrId: message.block4.MT20.msgId.content,
                            UETR: message.block3?.NdToNdTxRef?.value
                        },
                        SttlmTmReq: {
                        ...
                        PmtTpInf: {
                            ...
                            CtgyPurp: {
                                Cd: getMT103InstructionCode(message.block4.MT23E, 4)[6]
                            }
                        },
                        IntrBkSttlmDt: convertToISOStandardDate(message.block4.MT32A.Dt),
                        ...
                        Dbtr: {
                            Id: {
                                ...
                                PrvtId: {
                                    Othr: [
                                        {
                                            Id: getPartyIdentifierOrAccount(message.block4.MT50F?.PrtyIdn, PARTY_IDENTIER_ID)[0],
                                            SchmeNm: {
                                                Cd: getPartyIdentifierOrAccount(message.block4.MT50F?.PrtyIdn, PARTY_IDENTIFIER_CODE)[3]
                                            },
                        ...
                        RgltryRptg: getRegulatoryReporting(message.block4.MT77B),
                        RmtInf: {Ustrd: [check getMT103REMITEnvelopeContent(message.block4.MT77T)[0].ensureType(string)], Strd: []},
                        InstrForNxtAgt: [
                            {
                        ...
                        InstrForCdtrAgt: [
                            {
                                Cd: getMT103InstructionCode(message.block4.MT23E, 2)[2],
                                InstrInf: getMT103InstructionCode(message.block4.MT23E, 2)[3]
                            },
                            {
                                Cd: getMT1XXSenderToReceiverInformation(message.block4.MT72)[2],
                                InstrInf: getMT1XXSenderToReceiverInformation(message.block4.MT72)[3]
                        ...
                        SplmtryData: [{
                            Envlp: {
                                Nrtv: getEnvelopeContent(message.block4.MT77T)[2],
                                XmlContent: getEnvelopeContent(message.block4.MT77T)[1]
                            }
                        }]
                    }
                ]
                ...
                CdtTrfTxInf: [
                    {
                        ...
                        ChrgsInf: check getChargesInformation(message.block4.MT71F, message.block4.MT71G),
                        RgltryRptg: getRegulatoryReporting(message.block4.MT77B),
                        RmtInf: {Ustrd: [getRemmitanceInformation(message.block4.MT70)[1]], Strd: []},
                        InstrForNxtAgt: [
                            {
                                Cd: getMT103InstructionCode(message.block4.MT23E, 1)[0],
                                InstrInf: getMT103InstructionCode(message.block4.MT23E, 1)[1]
...
isolated function getDirectDebitTransactionInfoMT104(swiftmt:MT104Message message) returns pacsIsoRecord:DirectDebitTransactionInformation31[]|error {
    ...
    foreach swiftmt:MT104Transaction transaxion in message.block4.Transaction {
        ...
        drctDbtTxInfArray.push({
            ...
            CdtrAcct: {
                Id: {
                    IBAN: validateAccountNumber(creditor50A?.Acc, creditor50K?.Acc)[0],
                    Othr: {
                        Id: validateAccountNumber(creditor50A?.Acc, creditor50K?.Acc)[1],
                        SchmeNm: {
            ...
            DbtrAcct: {
                Id: {
                    IBAN: validateAccountNumber(transaxion.MT59A?.Acc, transaxion.MT59?.Acc)[0],
                    Othr: {
                        Id: validateAccountNumber(transaxion.MT59A?.Acc, transaxion.MT59?.Acc)[1],
                        SchmeNm: {
            ...
            RgltryRptg: getRegulatoryReporting(rgltryRptg),
            RmtInf: {
                Ustrd: [getRemmitanceInformation(transaxion.MT70)[1]],
                Strd: []
            }
        }
        );
            ...
            UndrlygCstmrCdtTrf: {
                Dbtr: {
                    Id: {
                        ...
                        PrvtId:{
                            Othr: [{
                                Id: getPartyIdentifierOrAccount(message.block4.UndrlygCstmrCdtTrf.MT50F?.PrtyIdn, "id")[0],
                                SchmeNm: {
                                    Cd: getPartyIdentifierOrAccount(message.block4.UndrlygCstmrCdtTrf.MT50F?.PrtyIdn, "cd")[3]
                                },
                ...
                RmtInf: {Ustrd: [getRemmitanceInformation(message.block4.UndrlygCstmrCdtTrf.MT70)[1]], Strd: []}
            }
        });
    return cdtTrfTxInfArray;
}
                        ...
                        Dbtr: {
                            Pty: {
                                ...
                                Id: {
                                    ...
                                    PrvtId: {
                                        Othr: [{
                                            Id: getPartyIdentifierOrAccount(message.block4.MT50F?.PrtyIdn, "id")[0],
                                            SchmeNm: {
                                                Cd: getPartyIdentifierOrAccount(message.block4.MT50F?.PrtyIdn, "cd")[3]
                                            },
                                            Issr: getPartyIdentifierOrAccount(message.block4.MT50F?.PrtyIdn)[4]
                                        }]
                                    }
